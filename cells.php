<?php
	...
	$pattern = new Automata("order");
	$pattern2 = new Automata("random");


	echo "num_cells: " . $pattern->num_cells . "<br />";
	echo "generations: " . $pattern->generations . "<br />";
...
<html>
	...
	<body>
		<div>
			<p>Order:</p><br/>
			<?php echo $pattern->output_string; ?>
		</div>
		<div>
			<p>Randomness</p><br />
			<?php echo $pattern2->output_string; ?>
		</div>
	</body>
</html>